...
global _1_not_const_msg_release
_1_not_const_msg_release:
    push rbp ; save executor frame pointer
    mov rbp, rsp ; establish new frame base
    sub rsp, 16 ; reserve stack space for locals
    mov [rbp-16], rdi ; store scalar arg in frame
...
not_const_msg:
    ...
    mov rax, _1_not_const_msg_release ; load release helper entry point
    mov qword [rdx+8], rax ; store release pointer in metadata
    mov rax, _1_not_const_msg_deepcopy ; load deep copy helper entry point
...
global not_const_msg_release
not_const_msg_release:
    push rbp ; save executor frame pointer
    mov rbp, rsp ; establish new frame base
    sub rsp, 16 ; reserve stack space for locals
    mov [rbp-16], rdi ; store scalar arg in frame
