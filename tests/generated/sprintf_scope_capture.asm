...
_8_foo_unwrapper:
    ...
    leave ; unwind before named jump
    jmp _8_foo ; jump to fully applied function
global exit
exit:
    push rbp ; save executor frame pointer
    mov rbp, rsp ; establish new frame base
...
_6_foo:
    ...
    mov rax, _8_foo_unwrapper ; load unwrapper entry point
...
_3_foo_unwrapper:
    ...
    pop rdi ; restore scalar arg into register
    leave ; unwind before named jump
    jmp _3_foo ; jump to fully applied function
global foo
foo:
    push rbp ; save executor frame pointer
    mov rbp, rsp ; establish new frame base
    ...
    mov qword [rdx+16], 40 ; heap size metadata
    mov qword [rdx+24], 0 ; pointer count metadata
    mov rax, _3_foo_unwrapper ; load unwrapper entry point
    mov qword [rdx+0], rax ; store unwrapper entry in metadata
    mov [rbp-48], rdx ; update closure env_end pointer
