...
print_sum:
    ...
    mov rax, _print_sum_3_closure_entry ; load wrapper entry point
...
print_sum_closure_entry:
    ...
    jmp print_sum ; jump into actual function
global _print_sum_3
_print_sum_3:
    push rbp ; save caller frame pointer
    mov rbp, rsp ; establish new frame base
...
_print_sum_3_closure_entry:
    ...
    pop rbx ; restore saved base register
    leave ; epilogue: restore rbp of caller
    jmp _print_sum_3 ; jump into actual function
global _1
_1:
    push rbp ; save caller frame pointer
    mov rbp, rsp ; establish new frame base
