...
run:
    ...
    mov rax, _run_k_2_closure_entry ; load wrapper entry point
    ...
    mov rax, _run_6_closure_entry ; load wrapper entry point
    sub rsp, 24 ; allocate temporary stack for closure state
    mov [rsp], rax ; save closure code pointer temporarily
    mov [rsp+8], rdx ; save closure env_end pointer temporarily
    ...
    mov qword [rdx+24], 8 ; closure env pointer slot offset
    mov qword [rdx+32], 24 ; closure env pointer slot offset
    mov rax, _run_8_closure_entry ; load wrapper entry point
    sub rsp, 24 ; allocate temporary stack for closure state
    mov [rsp], rax ; save closure code pointer temporarily
    mov [rsp+8], rdx ; save closure env_end pointer temporarily
    mov rax, [rbp-16] ; load closure code pointer
...
run_closure_entry:
    ...
    pop rbx ; restore saved base register
    leave ; epilogue: restore rbp of caller
    jmp run ; jump into actual function
global _run_k_2
_run_k_2:
    push rbp ; save caller frame pointer
    mov rbp, rsp ; establish new frame base
...
_run_k_2_closure_entry:
    ...
    pop rbx ; restore saved base register
    leave ; epilogue: restore rbp of caller
    jmp _run_k_2 ; jump into actual function
global _run_6
_run_6:
    push rbp ; save caller frame pointer
    mov rbp, rsp ; establish new frame base
...
_run_6_closure_entry:
    ...
    pop rbx ; restore saved base register
    leave ; epilogue: restore rbp of caller
    jmp _run_6 ; jump into actual function
global _run_8
_run_8:
    push rbp ; save caller frame pointer
    mov rbp, rsp ; establish new frame base
...
_run_8_closure_entry:
    ...
    pop rbx ; restore saved base register
    leave ; epilogue: restore rbp of caller
    jmp _run_8 ; jump into actual function
global _1
_1:
    push rbp ; save caller frame pointer
    mov rbp, rsp ; establish new frame base
