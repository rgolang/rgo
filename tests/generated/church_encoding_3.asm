...
_7_three_unwrapper:
    ...
    jmp _7_three ; jump to fully applied function
global _7_three_release
_7_three_release:
    push rbp ; save executor frame pointer
    mov rbp, rsp ; establish new frame base
    ...
    cmp rax, rbx
    jl _7_three_release_if_num_curried_lt_2
    ...
    mov rdi, rcx ; field release pointer
    call release_heap_ptr ; release heap pointer
    jmp _7_three_release_done
_7_three_release_if_num_curried_lt_2:
    mov rax, [rbp-32] ; load operand
    mov rbx, 1 ; operand literal
    cmp rax, rbx
    jl _7_three_release_if_num_curried_lt_1
    mov rbx, [rbp-16] ; load env_end pointer for release
    mov rcx, [rbx-24] ; load field pointer
    mov rdi, rcx ; field release pointer
    call release_heap_ptr ; release heap pointer
    jmp _7_three_release_done
_7_three_release_if_num_curried_lt_1:
_7_three_release_done:
    leave
    ret

global _7_three_deepcopy
_7_three_deepcopy:
    push rbp ; save executor frame pointer
    mov rbp, rsp ; establish new frame base
    ...
    mov rbx, 2 ; operand literal
    cmp rax, rbx
    jl _7_three_deepcopy_if_num_curried_lt_2
    mov rbx, [rbp-16] ; load env_end pointer for copy
    mov rcx, [rbx-24] ; load field pointer
    test rcx, rcx ; skip null field
    je _7_three_deepcopy_copy_field_null_0
    ...
    jmp _7_three_deepcopy_copy_field_done_1
_7_three_deepcopy_copy_field_null_0:
    xor rax, rax ; null copy result
_7_three_deepcopy_copy_field_done_1:
    mov [rbp-48], rax ; save evaluated scalar in frame
    mov rbx, [rbp-16] ; load env_end pointer for copy
    mov rcx, [rbx-16] ; load field pointer
    test rcx, rcx ; skip null field
    je _7_three_deepcopy_copy_field_null_2
    mov rdi, rcx ; copy pointer argument for deepcopy
    call deepcopy_heap_ptr ; duplicate heap pointer
    mov [rbx-16], rax ; store duplicated pointer
    jmp _7_three_deepcopy_copy_field_done_3
_7_three_deepcopy_copy_field_null_2:
    xor rax, rax ; null copy result
_7_three_deepcopy_copy_field_done_3:
    mov [rbp-64], rax ; save evaluated scalar in frame
    jmp _7_three_deepcopy_done
_7_three_deepcopy_if_num_curried_lt_2:
    mov rax, [rbp-32] ; load operand
    mov rbx, 1 ; operand literal
    cmp rax, rbx
    jl _7_three_deepcopy_if_num_curried_lt_1
    mov rbx, [rbp-16] ; load env_end pointer for copy
    mov rcx, [rbx-24] ; load field pointer
    test rcx, rcx ; skip null field
    je _7_three_deepcopy_copy_field_null_4
    mov rdi, rcx ; copy pointer argument for deepcopy
    call deepcopy_heap_ptr ; duplicate heap pointer
    mov [rbx-24], rax ; store duplicated pointer
    jmp _7_three_deepcopy_copy_field_done_5
_7_three_deepcopy_copy_field_null_4:
    xor rax, rax ; null copy result
_7_three_deepcopy_copy_field_done_5:
    mov [rbp-80], rax ; save evaluated scalar in frame
    jmp _7_three_deepcopy_done
_7_three_deepcopy_if_num_curried_lt_1:
_7_three_deepcopy_done:
    leave
    ret
...
_5_three:
    ...
    mov rax, _7_three_unwrapper ; load unwrapper entry point
    mov qword [rdx+0], rax ; store unwrapper entry in metadata
    mov rax, _7_three_release ; load release helper entry point
    mov qword [rdx+8], rax ; store release pointer in metadata
    mov rax, _7_three_deepcopy ; load deep copy helper entry point
...
_5_three_unwrapper:
    ...
    pop r8 ; restore scalar arg into register
    leave ; unwind before named jump
    jmp _5_three ; jump to fully applied function
global _5_three_release
_5_three_release:
    push rbp ; save executor frame pointer
    mov rbp, rsp ; establish new frame base
    sub rsp, 32 ; reserve stack space for locals
    ...
    mov rbx, 2 ; operand literal
    cmp rax, rbx
    jl _5_three_release_if_num_curried_lt_2
    mov rbx, [rbp-16] ; load env_end pointer for release
    mov rcx, [rbx-24] ; load field pointer
    mov rdi, rcx ; field release pointer
    call release_heap_ptr ; release heap pointer
    ...
    mov rdi, rcx ; field release pointer
    call release_heap_ptr ; release heap pointer
    jmp _5_three_release_done
_5_three_release_if_num_curried_lt_2:
    mov rax, [rbp-32] ; load operand
    mov rbx, 1 ; operand literal
    cmp rax, rbx
    jl _5_three_release_if_num_curried_lt_1
    mov rbx, [rbp-16] ; load env_end pointer for release
    mov rcx, [rbx-24] ; load field pointer
    mov rdi, rcx ; field release pointer
    call release_heap_ptr ; release heap pointer
    jmp _5_three_release_done
_5_three_release_if_num_curried_lt_1:
_5_three_release_done:
    leave
    ret

global _5_three_deepcopy
_5_three_deepcopy:
    push rbp ; save executor frame pointer
    mov rbp, rsp ; establish new frame base
    sub rsp, 80 ; reserve stack space for locals
    ...
    mov rbx, 2 ; operand literal
    cmp rax, rbx
    jl _5_three_deepcopy_if_num_curried_lt_2
    mov rbx, [rbp-16] ; load env_end pointer for copy
    mov rcx, [rbx-24] ; load field pointer
    test rcx, rcx ; skip null field
    je _5_three_deepcopy_copy_field_null_0
    mov rdi, rcx ; copy pointer argument for deepcopy
    call deepcopy_heap_ptr ; duplicate heap pointer
    mov [rbx-24], rax ; store duplicated pointer
    jmp _5_three_deepcopy_copy_field_done_1
_5_three_deepcopy_copy_field_null_0:
    xor rax, rax ; null copy result
_5_three_deepcopy_copy_field_done_1:
    mov [rbp-48], rax ; save evaluated scalar in frame
    mov rbx, [rbp-16] ; load env_end pointer for copy
    mov rcx, [rbx-16] ; load field pointer
    test rcx, rcx ; skip null field
    je _5_three_deepcopy_copy_field_null_2
    mov rdi, rcx ; copy pointer argument for deepcopy
    call deepcopy_heap_ptr ; duplicate heap pointer
    mov [rbx-16], rax ; store duplicated pointer
    jmp _5_three_deepcopy_copy_field_done_3
_5_three_deepcopy_copy_field_null_2:
    xor rax, rax ; null copy result
_5_three_deepcopy_copy_field_done_3:
    mov [rbp-64], rax ; save evaluated scalar in frame
    jmp _5_three_deepcopy_done
_5_three_deepcopy_if_num_curried_lt_2:
    mov rax, [rbp-32] ; load operand
    mov rbx, 1 ; operand literal
    cmp rax, rbx
    jl _5_three_deepcopy_if_num_curried_lt_1
    mov rbx, [rbp-16] ; load env_end pointer for copy
    mov rcx, [rbx-24] ; load field pointer
    test rcx, rcx ; skip null field
    je _5_three_deepcopy_copy_field_null_4
    mov rdi, rcx ; copy pointer argument for deepcopy
    call deepcopy_heap_ptr ; duplicate heap pointer
    mov [rbx-24], rax ; store duplicated pointer
    jmp _5_three_deepcopy_copy_field_done_5
_5_three_deepcopy_copy_field_null_4:
    xor rax, rax ; null copy result
_5_three_deepcopy_copy_field_done_5:
    mov [rbp-80], rax ; save evaluated scalar in frame
    jmp _5_three_deepcopy_done
_5_three_deepcopy_if_num_curried_lt_1:
_5_three_deepcopy_done:
    leave
    ret
...
three:
    ...
    mov qword [rdx+24], 24 ; env size metadata
    mov qword [rdx+32], 72 ; heap size metadata
    mov rax, _5_three_unwrapper ; load unwrapper entry point
    mov qword [rdx+0], rax ; store unwrapper entry in metadata
    mov rax, _5_three_release ; load release helper entry point
    mov qword [rdx+8], rax ; store release pointer in metadata
    mov rax, _5_three_deepcopy ; load deep copy helper entry point
    mov qword [rdx+16], rax ; store deep copy pointer in metadata
    xor rax, rax ; zero num_curried metadata
    mov qword [rdx+40], rax ; store num_curried
    sub rsp, 24 ; allocate temporary stack for closure state
...
global _13_lambda_unwrapper
_13_lambda_unwrapper:
    push rbp ; save executor frame pointer
    mov rbp, rsp ; establish new frame base
    sub rsp, 48 ; reserve stack space for locals
    mov [rbp-16], rdi ; store scalar arg in frame
    ...
    leave ; unwind before named jump
    jmp _13_lambda ; jump to fully applied function
global _13_lambda_release
_13_lambda_release:
    push rbp ; save executor frame pointer
    mov rbp, rsp ; establish new frame base
    sub rsp, 32 ; reserve stack space for locals
    ...
    mov rbx, 1 ; operand literal
    cmp rax, rbx
    jl _13_lambda_release_if_num_curried_lt_1
    mov rbx, [rbp-16] ; load env_end pointer for release
    mov rcx, [rbx-8] ; load field pointer
    mov rdi, rcx ; field release pointer
    call release_heap_ptr ; release heap pointer
    jmp _13_lambda_release_done
_13_lambda_release_if_num_curried_lt_1:
_13_lambda_release_done:
    leave
    ret

global _13_lambda_deepcopy
_13_lambda_deepcopy:
    push rbp ; save executor frame pointer
    mov rbp, rsp ; establish new frame base
    sub rsp, 48 ; reserve stack space for locals
    ...
    mov rbx, 1 ; operand literal
    cmp rax, rbx
    jl _13_lambda_deepcopy_if_num_curried_lt_1
    mov rbx, [rbp-16] ; load env_end pointer for copy
    mov rcx, [rbx-8] ; load field pointer
    test rcx, rcx ; skip null field
    je _13_lambda_deepcopy_copy_field_null_0
    mov rdi, rcx ; copy pointer argument for deepcopy
    call deepcopy_heap_ptr ; duplicate heap pointer
    mov [rbx-8], rax ; store duplicated pointer
    jmp _13_lambda_deepcopy_copy_field_done_1
_13_lambda_deepcopy_copy_field_null_0:
    xor rax, rax ; null copy result
_13_lambda_deepcopy_copy_field_done_1:
    mov [rbp-48], rax ; save evaluated scalar in frame
    jmp _13_lambda_deepcopy_done
_13_lambda_deepcopy_if_num_curried_lt_1:
_13_lambda_deepcopy_done:
    leave
    ret
...
global _21_lambda_unwrapper
_21_lambda_unwrapper:
    push rbp ; save executor frame pointer
    mov rbp, rsp ; establish new frame base
    sub rsp, 16 ; reserve stack space for locals
    mov [rbp-16], rdi ; store scalar arg in frame
    ...
    call release_heap_ptr ; release closure environment
    leave ; unwind before named jump
    jmp _21_lambda ; jump to fully applied function
global _21_lambda_release
_21_lambda_release:
    push rbp ; save executor frame pointer
    mov rbp, rsp ; establish new frame base
    sub rsp, 16 ; reserve stack space for locals
...
_18_lambda:
    ...
    mov rax, _21_lambda_unwrapper ; load unwrapper entry point
    mov qword [rdx+0], rax ; store unwrapper entry in metadata
    mov rax, _21_lambda_release ; load release helper entry point
    mov qword [rdx+8], rax ; store release pointer in metadata
    mov rax, _21_lambda_deepcopy ; load deep copy helper entry point
    mov qword [rdx+16], rax ; store deep copy pointer in metadata
    xor rax, rax ; zero num_curried metadata
    mov qword [rdx+40], rax ; store num_curried
    mov [rbp-48], rdx ; update closure env_end pointer
...
_start:
    ...
    mov rax, _13_lambda_unwrapper ; load unwrapper entry point
    mov qword [rdx+0], rax ; store unwrapper entry in metadata
    mov rax, _13_lambda_release ; load release helper entry point
    mov qword [rdx+8], rax ; store release pointer in metadata
    mov rax, _13_lambda_deepcopy ; load deep copy helper entry point
    mov qword [rdx+16], rax ; store deep copy pointer in metadata
    xor rax, rax ; zero num_curried metadata
    mov qword [rdx+40], rax ; store num_curried
    mov [rbp-32], rdx ; update closure env_end pointer
