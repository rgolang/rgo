...
itoa_deep_release:
    ...
    cmp rax, rbx
    jg itoa_release_skip_1
    mov rax, [r12-8] ; load itoa_release_field_1 env field
    mov [rbp-24], rax ; store value
