...
foo:
    ...
    mov rax, _foo_w_0_closure_entry ; load wrapper entry point
...
_foo_w_0_write_strlen_loop_0:
    mov dl, byte [r8+rcx] ; load current character
    cmp dl, 0 ; stop at terminator
    je _foo_w_0_write_strlen_done_0
    inc rcx ; advance char counter
    jmp _foo_w_0_write_strlen_loop_0
_foo_w_0_write_strlen_done_0:
...
_foo_w_0_closure_entry:
    ...
    pop rbx ; restore saved base register
    leave ; epilogue: restore rbp of caller
    jmp _foo_w_0 ; jump into actual function
global _2
_2:
    push rbp ; save caller frame pointer
    mov rbp, rsp ; establish new frame base
