...
_0_foo_w_unwrapper:
    ...
    jmp _0_foo_w ; jump to fully applied function
global _0_foo_w_release
_0_foo_w_release:
    push rbp ; save executor frame pointer
    mov rbp, rsp ; establish new frame base
    ...
    cmp rax, rbx
    jl _0_foo_w_release_if_num_curried_lt_1
    ...
    jmp _0_foo_w_release_done
_0_foo_w_release_if_num_curried_lt_1:
_0_foo_w_release_done:
    leave
    ret

global _0_foo_w_deepcopy
_0_foo_w_deepcopy:
    push rbp ; save executor frame pointer
    mov rbp, rsp ; establish new frame base
    sub rsp, 48 ; reserve stack space for locals
    ...
    mov rbx, 1 ; operand literal
    cmp rax, rbx
    jl _0_foo_w_deepcopy_if_num_curried_lt_1
    mov rbx, [rbp-16] ; load env_end pointer for copy
    mov rcx, [rbx-16] ; load field pointer
    test rcx, rcx ; skip null field
    je _0_foo_w_deepcopy_copy_field_null_0
    ...
    jmp _0_foo_w_deepcopy_copy_field_done_1
_0_foo_w_deepcopy_copy_field_null_0:
    xor rax, rax ; null copy result
_0_foo_w_deepcopy_copy_field_done_1:
    mov [rbp-48], rax ; save evaluated scalar in frame
    jmp _0_foo_w_deepcopy_done
_0_foo_w_deepcopy_if_num_curried_lt_1:
_0_foo_w_deepcopy_done:
    leave
    ret
