...
bar:
    ...
    mov rax, _2_bar_release ; load release helper entry point
    mov qword [rdx+8], rax ; store release pointer in metadata
    mov rax, _2_bar_deepcopy ; load deep copy helper entry point
...
_5_foo_bar_release:
    ...
    cmp rax, rbx
    jl _5_foo_bar_release_if_num_curried_lt_1
...
_5_foo_bar_deepcopy:
    ...
    mov rbx, 1 ; operand literal
    cmp rax, rbx
    jl _5_foo_bar_deepcopy_if_num_curried_lt_1
    mov rbx, [rbp-16] ; load env_end pointer for copy
    mov rcx, [rbx-8] ; load field pointer
    test rcx, rcx ; skip null field
    je _5_foo_bar_deepcopy_copy_field_null_0
    ...
    jmp _5_foo_bar_deepcopy_copy_field_done_1
_5_foo_bar_deepcopy_copy_field_null_0:
    xor rax, rax ; null copy result
_5_foo_bar_deepcopy_copy_field_done_1:
    mov [rbp-48], rax ; save evaluated scalar in frame
    jmp _5_foo_bar_deepcopy_done
