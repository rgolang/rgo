...
foo:
    ...
    jmp _foo_0 ; jump to fully applied function
foo_closure_entry:
    push rbp ; save caller frame pointer
...
_foo__foo_0_2_closure_entry:
    ...
    pop rbx ; restore saved base register
    leave ; epilogue: restore rbp of caller
    jmp _foo__foo_0_2 ; jump into actual function
global _foo_0
_foo_0:
    push rbp ; save caller frame pointer
    mov rbp, rsp ; establish new frame base
    ...
    mov rax, _foo__foo_0_2_closure_entry ; load wrapper entry point
...
_foo_0_write_strlen_loop_0:
    mov dl, byte [r8+rcx] ; load current character
    cmp dl, 0 ; stop at terminator
    je _foo_0_write_strlen_done_0
    inc rcx ; advance char counter
    jmp _foo_0_write_strlen_loop_0
_foo_0_write_strlen_done_0:
...
_foo_0_closure_entry:
    ...
    pop rbx ; restore saved base register
    leave ; epilogue: restore rbp of caller
    jmp _foo_0 ; jump into actual function
global _start
_start:
    push rbp ; save caller frame pointer
    mov rbp, rsp ; establish new frame base
