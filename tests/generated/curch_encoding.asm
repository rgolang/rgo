...
__lambda_4:
    ...
    mov rax, __lambda_5_closure_entry ; load wrapper entry point
    sub rsp, 16 ; allocate temporary stack for closure state
    mov [rsp], rax ; save closure code pointer temporarily
    mov [rsp+8], rdx ; save closure env_end pointer temporarily
    mov rax, [rsp] ; restore closure code pointer
...
__lambda_4_closure_entry:
    ...
    pop rbx ; restore saved base register
    leave ; epilogue: restore rbp of caller
    jmp __lambda_4 ; jump into actual function
global __lambda_5
__lambda_5:
    push rbp ; save caller frame pointer
    mov rbp, rsp ; establish new frame base
...
__lambda_5_closure_entry:
    ...
    pop rbx ; restore saved base register
    leave ; epilogue: restore rbp of caller
    jmp __lambda_5 ; jump into actual function
global _start
_start:
    push rbp ; save caller frame pointer
    mov rbp, rsp ; establish new frame base
    ...
    mov rax, __lambda_4_closure_entry ; load wrapper entry point
    sub rsp, 16 ; allocate temporary stack for closure state
    mov [rsp], rax ; save closure code pointer temporarily
    mov [rsp+8], rdx ; save closure env_end pointer temporarily
    mov rax, [rsp] ; restore closure code pointer
