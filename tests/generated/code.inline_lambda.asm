...
__0_2_closure_entry:
    ...
    jmp __0_2 ; jump into actual function
global _0
_0:
    push rbp ; save caller frame pointer
    mov rbp, rsp ; establish new frame base
    ...
    mov rax, __0_2_closure_entry ; load wrapper entry point
...
_0_closure_entry:
    ...
    pop rbx ; restore saved base register
    leave ; epilogue: restore rbp of caller
    jmp _0 ; jump into actual function
global _start
_start:
    push rbp ; save caller frame pointer
    mov rbp, rsp ; establish new frame base
    ...
    jmp _0 ; jump to fully applied function
extern fflush
extern printf
extern stdout
section .rodata
