...
write_unwrapper:
    ...
    jmp write ; jump to fully applied function
global write_release
write_release:
    push rbp ; save executor frame pointer
    mov rbp, rsp ; establish new frame base
    ...
    cmp rax, rbx
    jl write_release_if_num_curried_lt_1
    ...
    jmp write_release_done
write_release_if_num_curried_lt_1:
write_release_done:
    leave
    ret

global write_deepcopy
write_deepcopy:
    push rbp ; save executor frame pointer
    mov rbp, rsp ; establish new frame base
    sub rsp, 48 ; reserve stack space for locals
    ...
    mov rbx, 1 ; operand literal
    cmp rax, rbx
    jl write_deepcopy_if_num_curried_lt_1
    mov rbx, [rbp-16] ; load env_end pointer for copy
    mov rcx, [rbx-8] ; load field pointer
    test rcx, rcx ; skip null field
    je write_deepcopy_copy_field_null_0
    ...
    jmp write_deepcopy_copy_field_done_1
write_deepcopy_copy_field_null_0:
    xor rax, rax ; null copy result
write_deepcopy_copy_field_done_1:
    mov [rbp-48], rax ; save evaluated scalar in frame
    jmp write_deepcopy_done
