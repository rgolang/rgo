...
_iterate_0_release:
    ...
    cmp rax, rbx
    jl _iterate_0_release_if_num_curried_lt_4
    mov rbx, [rbp-16] ; load env_end pointer for release
    ...
    mov rdi, rcx ; field release pointer
    call release_heap_ptr ; release heap pointer
    jmp _iterate_0_release_done
_iterate_0_release_if_num_curried_lt_4:
    mov rax, [rbp-32] ; load operand
    mov rbx, 3 ; operand literal
    cmp rax, rbx
    jl _iterate_0_release_if_num_curried_lt_3
    mov rbx, [rbp-16] ; load env_end pointer for release
    mov rcx, [rbx-40] ; load field pointer
    mov rdi, rcx ; field release pointer
    call release_heap_ptr ; release heap pointer
    ...
    call release_heap_ptr ; release heap pointer
    jmp _iterate_0_release_done
_iterate_0_release_if_num_curried_lt_3:
    mov rax, [rbp-32] ; load operand
    mov rbx, 2 ; operand literal
    cmp rax, rbx
    jl _iterate_0_release_if_num_curried_lt_2
    mov rbx, [rbp-16] ; load env_end pointer for release
    mov rcx, [rbx-40] ; load field pointer
    mov rdi, rcx ; field release pointer
    call release_heap_ptr ; release heap pointer
    ...
    call release_heap_ptr ; release heap pointer
    jmp _iterate_0_release_done
_iterate_0_release_if_num_curried_lt_2:
    mov rax, [rbp-32] ; load operand
    mov rbx, 1 ; operand literal
    cmp rax, rbx
    jl _iterate_0_release_if_num_curried_lt_1
    mov rbx, [rbp-16] ; load env_end pointer for release
    mov rcx, [rbx-40] ; load field pointer
    mov rdi, rcx ; field release pointer
    call release_heap_ptr ; release heap pointer
    jmp _iterate_0_release_done
_iterate_0_release_if_num_curried_lt_1:
_iterate_0_release_done:
    leave
    ret

global _iterate_0_deepcopy
_iterate_0_deepcopy:
    push rbp ; save executor frame pointer
    mov rbp, rsp ; establish new frame base
    ...
    mov rbx, 4 ; operand literal
    cmp rax, rbx
    jl _iterate_0_deepcopy_if_num_curried_lt_4
    mov rbx, [rbp-16] ; load env_end pointer for copy
    mov rcx, [rbx-40] ; load field pointer
    test rcx, rcx ; skip null field
    je _iterate_0_deepcopy_copy_field_null_0
    mov rdi, rcx ; copy pointer argument for deepcopy
    call deepcopy_heap_ptr ; duplicate heap pointer
    mov [rbx-40], rax ; store duplicated pointer
    jmp _iterate_0_deepcopy_copy_field_done_1
_iterate_0_deepcopy_copy_field_null_0:
    xor rax, rax ; null copy result
_iterate_0_deepcopy_copy_field_done_1:
    mov [rbp-48], rax ; save evaluated scalar in frame
    mov rbx, [rbp-16] ; load env_end pointer for copy
    mov rcx, [rbx-32] ; load field pointer
    test rcx, rcx ; skip null field
    je _iterate_0_deepcopy_copy_field_null_2
    mov rdi, rcx ; copy pointer argument for deepcopy
    call deepcopy_heap_ptr ; duplicate heap pointer
    mov [rbx-32], rax ; store duplicated pointer
    jmp _iterate_0_deepcopy_copy_field_done_3
_iterate_0_deepcopy_copy_field_null_2:
    xor rax, rax ; null copy result
_iterate_0_deepcopy_copy_field_done_3:
    mov [rbp-64], rax ; save evaluated scalar in frame
    mov rbx, [rbp-16] ; load env_end pointer for copy
    mov rcx, [rbx-24] ; load field pointer
    test rcx, rcx ; skip null field
    je _iterate_0_deepcopy_copy_field_null_4
    mov rdi, rcx ; copy pointer argument for deepcopy
    call deepcopy_heap_ptr ; duplicate heap pointer
    mov [rbx-24], rax ; store duplicated pointer
    jmp _iterate_0_deepcopy_copy_field_done_5
_iterate_0_deepcopy_copy_field_null_4:
    xor rax, rax ; null copy result
_iterate_0_deepcopy_copy_field_done_5:
    mov [rbp-80], rax ; save evaluated scalar in frame
    mov rbx, [rbp-16] ; load env_end pointer for copy
    mov rcx, [rbx-8] ; load field pointer
    test rcx, rcx ; skip null field
    je _iterate_0_deepcopy_copy_field_null_6
    mov rdi, rcx ; copy pointer argument for deepcopy
    call deepcopy_heap_ptr ; duplicate heap pointer
    mov [rbx-8], rax ; store duplicated pointer
    jmp _iterate_0_deepcopy_copy_field_done_7
_iterate_0_deepcopy_copy_field_null_6:
    xor rax, rax ; null copy result
_iterate_0_deepcopy_copy_field_done_7:
    mov [rbp-96], rax ; save evaluated scalar in frame
    jmp _iterate_0_deepcopy_done
_iterate_0_deepcopy_if_num_curried_lt_4:
    mov rax, [rbp-32] ; load operand
    mov rbx, 3 ; operand literal
    cmp rax, rbx
    jl _iterate_0_deepcopy_if_num_curried_lt_3
    mov rbx, [rbp-16] ; load env_end pointer for copy
    mov rcx, [rbx-40] ; load field pointer
    test rcx, rcx ; skip null field
    je _iterate_0_deepcopy_copy_field_null_8
    mov rdi, rcx ; copy pointer argument for deepcopy
    call deepcopy_heap_ptr ; duplicate heap pointer
    mov [rbx-40], rax ; store duplicated pointer
    jmp _iterate_0_deepcopy_copy_field_done_9
_iterate_0_deepcopy_copy_field_null_8:
    xor rax, rax ; null copy result
_iterate_0_deepcopy_copy_field_done_9:
    mov [rbp-112], rax ; save evaluated scalar in frame
    mov rbx, [rbp-16] ; load env_end pointer for copy
    mov rcx, [rbx-32] ; load field pointer
    test rcx, rcx ; skip null field
    je _iterate_0_deepcopy_copy_field_null_10
    mov rdi, rcx ; copy pointer argument for deepcopy
    call deepcopy_heap_ptr ; duplicate heap pointer
    mov [rbx-32], rax ; store duplicated pointer
    jmp _iterate_0_deepcopy_copy_field_done_11
_iterate_0_deepcopy_copy_field_null_10:
    xor rax, rax ; null copy result
_iterate_0_deepcopy_copy_field_done_11:
    mov [rbp-128], rax ; save evaluated scalar in frame
    mov rbx, [rbp-16] ; load env_end pointer for copy
    mov rcx, [rbx-24] ; load field pointer
    test rcx, rcx ; skip null field
    je _iterate_0_deepcopy_copy_field_null_12
    mov rdi, rcx ; copy pointer argument for deepcopy
    call deepcopy_heap_ptr ; duplicate heap pointer
    mov [rbx-24], rax ; store duplicated pointer
    jmp _iterate_0_deepcopy_copy_field_done_13
_iterate_0_deepcopy_copy_field_null_12:
    xor rax, rax ; null copy result
_iterate_0_deepcopy_copy_field_done_13:
    mov [rbp-144], rax ; save evaluated scalar in frame
    jmp _iterate_0_deepcopy_done
_iterate_0_deepcopy_if_num_curried_lt_3:
    mov rax, [rbp-32] ; load operand
    mov rbx, 2 ; operand literal
    cmp rax, rbx
    jl _iterate_0_deepcopy_if_num_curried_lt_2
    mov rbx, [rbp-16] ; load env_end pointer for copy
    mov rcx, [rbx-40] ; load field pointer
    test rcx, rcx ; skip null field
    je _iterate_0_deepcopy_copy_field_null_14
    mov rdi, rcx ; copy pointer argument for deepcopy
    call deepcopy_heap_ptr ; duplicate heap pointer
    mov [rbx-40], rax ; store duplicated pointer
    jmp _iterate_0_deepcopy_copy_field_done_15
_iterate_0_deepcopy_copy_field_null_14:
    xor rax, rax ; null copy result
_iterate_0_deepcopy_copy_field_done_15:
    mov [rbp-160], rax ; save evaluated scalar in frame
    mov rbx, [rbp-16] ; load env_end pointer for copy
    mov rcx, [rbx-32] ; load field pointer
    test rcx, rcx ; skip null field
    je _iterate_0_deepcopy_copy_field_null_16
    mov rdi, rcx ; copy pointer argument for deepcopy
    call deepcopy_heap_ptr ; duplicate heap pointer
    mov [rbx-32], rax ; store duplicated pointer
    jmp _iterate_0_deepcopy_copy_field_done_17
_iterate_0_deepcopy_copy_field_null_16:
    xor rax, rax ; null copy result
_iterate_0_deepcopy_copy_field_done_17:
    mov [rbp-176], rax ; save evaluated scalar in frame
    jmp _iterate_0_deepcopy_done
_iterate_0_deepcopy_if_num_curried_lt_2:
    mov rax, [rbp-32] ; load operand
    mov rbx, 1 ; operand literal
    cmp rax, rbx
    jl _iterate_0_deepcopy_if_num_curried_lt_1
    mov rbx, [rbp-16] ; load env_end pointer for copy
    mov rcx, [rbx-40] ; load field pointer
    test rcx, rcx ; skip null field
    je _iterate_0_deepcopy_copy_field_null_18
    mov rdi, rcx ; copy pointer argument for deepcopy
    call deepcopy_heap_ptr ; duplicate heap pointer
    mov [rbx-40], rax ; store duplicated pointer
    jmp _iterate_0_deepcopy_copy_field_done_19
_iterate_0_deepcopy_copy_field_null_18:
    xor rax, rax ; null copy result
_iterate_0_deepcopy_copy_field_done_19:
    mov [rbp-192], rax ; save evaluated scalar in frame
    jmp _iterate_0_deepcopy_done
_iterate_0_deepcopy_if_num_curried_lt_1:
_iterate_0_deepcopy_done:
    leave
    ret
...
iterate:
    ...
    mov qword [rdx+0], rax ; store unwrapper entry in metadata
    mov rax, _iterate_0_release ; load release helper entry point
    mov qword [rdx+8], rax ; store release pointer in metadata
    mov rax, _iterate_0_deepcopy ; load deep copy helper entry point
    mov qword [rdx+16], rax ; store deep copy pointer in metadata
    xor rax, rax ; zero num_curried metadata
    mov qword [rdx+40], rax ; store num_curried
    sub rsp, 24 ; allocate temporary stack for closure state
...
global end
    ...
    mov qword [rdx+0], rax ; store unwrapper entry in metadata
    mov rax, _end_1_release ; load release helper entry point
    mov qword [rdx+8], rax ; store release pointer in metadata
    mov rax, _end_1_deepcopy ; load deep copy helper entry point
    mov qword [rdx+16], rax ; store deep copy pointer in metadata
    xor rax, rax ; zero num_curried metadata
    mov qword [rdx+40], rax ; store num_curried
    mov [rbp-32], rdx ; update closure env_end pointer
